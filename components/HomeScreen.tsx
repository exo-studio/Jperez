    ...
    <div className="animate-in fade-in duration-300 flex flex-col min-h-screen relative">
      ...
      <div className="px-6 lg:px-12 py-8 space-y-6 relative z-20 max-w-6xl mx-auto w-full bg-[#121212]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {/* WhatsApp - Larger, Featured */}
          <button
            onClick={onWhatsApp}
            className="md:col-span-1 bg-[#25D366] rounded-3xl p-6 flex flex-col items-center justify-center gap-3 group active:scale-[0.98] transition-all shadow-[0_10px_30px_rgba(37,211,102,0.3)] hover:shadow-[0_15px_40px_rgba(37,211,102,0.4)]"
          >
          ...
          {/* Share - Larger, Featured */}
          <button
            onClick={() => navigate('/share')}
            className="md:col-span-1 bg-[#0066B3] rounded-3xl p-6 flex flex-col items-center justify-center gap-3 group active:scale-[0.98] transition-all shadow-[0_10px_30px_rgba(0,102,179,0.3)] hover:shadow-[0_15px_40px_rgba(0,102,179,0.4)]"
          >
          ...
          {/* Maps/Offices - Larger, Featured */}
          <button
            onClick={() => setIsMapModalOpen(true)}
            className="col-span-2 md:col-span-1 bg-white rounded-3xl p-6 flex flex-col items-center justify-center gap-3 group active:scale-[0.98] transition-all shadow-[0_10px_30px_rgba(66,133,244,0.3)] hover:shadow-[0_15px_40px_rgba(66,133,244,0.4)]"
          >
            {/* Logo oficial de Google Maps */}
            <img src="/logos/googlemapsicon.svg" alt="Google Maps" className="w-10 h-10" />
            <span className="text-[9px] font-black uppercase tracking-widest text-[#5f6368]">{t.viewOffices}</span>
          </button>
        </div>
